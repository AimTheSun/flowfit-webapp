...
public class Client {
    ...
    @Enumerated(EnumType.STRING)
    @Column(nullable = false)
    private ClientStatusInGym insideGym = ClientStatusInGym.OUTSIDEGYM;


    private String password;

   public enum ClientStatusInGym {
       INSIDEGYM, OUTSIDEGYM
   }
    ...
    public ClientStatusInGym getInsideGym() {
        return insideGym;
    }

    public void setInsideGym(ClientStatusInGym insideGym) {
        this.insideGym = insideGym;
    }
